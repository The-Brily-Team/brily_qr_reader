  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (isOk) {
        ...
        Navigator.of(context).pop('No permissions to access the camera');
      }
    });
  }
        ...
        : Material(
            ...
            child: LayoutBuilder(builder: (context, constraints) {
              ...
              if (constraints.maxHeight < qrScanSize * 1.5) {
                print(
                    "The ratio of the recommended height to the height of the scanning area is greater than 1.5");
              }
              return Stack(
                children: <Widget>[
                  SizedBox(
